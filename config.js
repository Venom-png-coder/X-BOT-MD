...
const SESSION_ID = process.env.SESSION_ID || "A-S-W-I-N-S-P-A-R-K-Y:d144b3cd7e640baca1172b806732aa20";
const SUDO = process.env.SUDO || '254748423791';
...
const BOT_INFO = process.env.BOT_INFO || "VENOM-BOT-MD;ASWIN SPARKY;https://i.imgur.com/r3GZeiX.jpeg";
const URL = process.env.URL || "https://www.instagram.com/sparky.drip";
const AUDIO_DATA = process.env.AUDIO_DATA || "VENOM BOT MD;ASWIN SPARKY;https://i.imgur.com/fVCRCYG.jpeg";
const STICKER_DATA = process.env.STICKER_DATA || "VENOM BOT MD;ASWIN SPARKY";
